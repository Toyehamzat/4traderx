...
function Account() {
  ...
  const [myChoice, setMyChoice] = useState("Operations");
  ...
  return (
    <div className="Account-page">
      ...
      <div className="part">
        ...
        <div className="first-content-account" data-aos="">
          ...
          <div className="notificate" data-aos="zoom-in">
          ...
          <div className="transactions-operations">
            {choices.map((choice) => (
              <button
                type="button"
                key={choice}
                className={click ? "choice-btn active" : "choice-btn"}
                onClick={() => {
                  setMyChoice(choice);
                  setclick(!click);
                }}
            ...
            <div>
              <div className="titles">
                ...
                <div className="sub-sub-title">
                  View and share your account details
                </div>
              </div>
              <hr />
              <div className="titles">
